...
{
    public class KharediNondDataForGiver
    {
    ...
    public class UserDTLForKharediNond
    {
   ...
   /* public class Aapak
    ...
    public class areaForMutationDTLKarediNond
    {
    ...
    public class AddressDTLForKharediNond
    {
    ...
    public class IndiaAddressForKharediNond
    {
    ...
    public class EditKharediNondDataForGiver
    {
