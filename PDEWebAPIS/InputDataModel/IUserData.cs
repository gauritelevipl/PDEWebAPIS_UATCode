...
namespace PDEWebAPIS.InputDataModel
{
    public interface IUserData
    {
        ...
        public class UserDetailsData
        {
            ...
            public TalukaData? taluka { set; get; }
            public VillageData? village { set; get; }
        ...
        public class IndiaAddressData
        {
            ...
            public string emailOTP { set; get; } = string.Empty;
            public string securityKey { set; get; } = string.Empty;
            public string? signatureName { set; get; }
            public string? signatureSrc { set; get; }
        }
    }
